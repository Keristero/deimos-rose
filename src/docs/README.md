...
| 8 — Netcode enhancements | in progress — stage 1 (diagnostics overlay) done; level select, pause-on-disconnect, reconnect, synchronised pausing still open | [phase-8-netcode-enhancements.md](phase-8-netcode-enhancements.md) |
