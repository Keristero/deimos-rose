...
| 7 — Faithful menus | in progress — stages 1 (Main Menu), 2 (Level Select), 3 (Credits) and 5 (minimal Pause) done; 4 (High Scores) and 6 (`-classic` gating) unstarted | [phase-7-faithful-menus.md](phase-7-faithful-menus.md) |
