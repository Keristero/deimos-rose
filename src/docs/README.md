...
| 7 — Faithful menus | in progress — stages 1 (Main Menu) and 5 (minimal Pause) done; 2-4 (Level Select, Credits, High Scores) and 6 (`-classic` gating) unstarted | [phase-7-faithful-menus.md](phase-7-faithful-menus.md) |
